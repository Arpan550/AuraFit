...
import com.example.aurafit.adapters.Exercise30RVAdapter
import com.example.aurafit.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = Exercise30RVAdapter(requireContext(), getExercises()) { exercise ->
    ...
    private fun onExerciseClicked(exercise: Exercises) {
    ...
    fun getExercises(): List<Exercises> {
        return listOf(
            ...
            // Core and Abdominal Muscles Exercises
            Exercises(
                "Bicycle Crunches",
            ...
            Exercises(
                "Side Plank",
                "https://images.everydayhealth.com/images/healthy-living/fitness/side-plank5e2e280470484037aba9d4c9cef43f80.gif?w=1110",
                listOf(
