package com.example.aurafit.bottom_nav_fragments.physical_fitness.music
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        retrofitData.enqueue(object : Callback<MusicData?> {
            override fun onResponse(call: Call<MusicData?>, response: Response<MusicData?>) {
                ...
                if (dataList != null) {
                    recyclerView.adapter = MusicRecyclerViewAdapter(this@MusicActivity, dataList, mediaPlayer)
                }
